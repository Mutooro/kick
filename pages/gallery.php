            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="breadcromb-box">
                        <h2>gallery</h2>
                        <ul>
                            <li><a href="gallery.html#"><i class="fa fa-home"></i> home</a></li>
                            <li>/</li>
                            <li>gallery</li>
                        </ul>
                    </div>
                ...
                <div class="col-md-12">
                    <div class="big-isotope-project">
                        <div class="projectFilter project-btn-const">
                            <a href="gallery.html#" data-filter="*" class="current">All items</a>
                            <a href="gallery.html#" data-filter=".construction">football</a>
                            <a href="gallery.html#" data-filter=".renovation">player</a>
                            <a href="gallery.html#" data-filter=".plumbing">stadium</a>
                            <a href="gallery.html#" data-filter=".flooring">shoes</a>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="pagination-box">
                        <ul class="pagination">
                            <li><a href="gallery.html#"><i class="fa fa-angle-double-left"></i></a></li>
                            <li><a href="gallery.html#">1</a></li>
                            <li><a href="gallery.html#">2</a></li>
                            <li class="active"><a href="gallery.html#">3</a></li>
                            <li><a href="gallery.html#">4</a></li>
                            <li><a href="gallery.html#">5</a></li>
                        ...
                        <div class="single-footer-widget">
                            ...
                            <ul class="single-footer-address">
                                ...
                                <li>
                                    ...
                                    <p><a href="gallery.html#">info@companyname.co</a></p>
                                </li>
                                <li>
                                    <div class="add-icon">
                                        <i class="fa fa-phone"></i>
                                    </div>
                                    <p><a href="gallery.html#">+123-456-78990</a></p>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="single-footer-widget">
                            ...
                            <ul class="single-footer-social">
                                <li>
                                    <a href="gallery.html#" class="fb"><i class="fa fa-facebook"></i></a>
                                </li>
                                <li>
                                    <a href="gallery.html#" class="twit"><i class="fa fa-twitter"></i></a>
                                </li>
                                <li>
                                    <a href="gallery.html#" class="linkedin"><i class="fa fa-linkedin"></i></a>
                                </li>
                                <li>
                                    <a href="gallery.html#" class="google"><i class="fa fa-google-plus"></i></a>
                                </li>
                                <li>
                                   <a href="gallery.html#" class="skype"><i class="fa fa-skype"></i></a>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="copyright">
                            <p class="desktop">
                                Copyright &copy; 2017 <a href="gallery.html#">kick</a>
