                                ...
                                <nav>
                                    <ul id="navigation_menu_2">
                                        ...
                                        <li class="current-page-item">
                                            <a href="registration.html#">page</a>
                                            <ul>
                                                <!-- <li>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="login-page-box">
                        ...
                        <form action="" autocompletion="off">
                            ...
                            <div class="account-form-group">
                                <!-- <label style="position: absolute; padding: 5px">&nbsp;&nbsp;&nbsp;
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Role:</label> -->
                            <select name="role" style="padding-top: 5px; border:none">
                            ...
                            <div class="account-form-group">
                                <input type="password" placeholder="Choose Password" name="email" >
                                <i class="fa fa-lock"></i>
                            </div>
                            <div class="account-form-group">
                        ...
                        <div class="single-footer-widget">
                            ...
                            <ul class="single-footer-address">
                                ...
                                <li>
                                    ...
                                    <p><a href="registration.html#">info@companyname.co</a></p>
                                </li>
                                <li>
                                    <div class="add-icon">
                                        <i class="fa fa-phone"></i>
                                    </div>
                                    <p><a href="registration.html#">+123-456-78990</a></p>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="single-footer-widget">
                            ...
                            <ul class="single-footer-social">
                                <li>
                                    <a href="registration.html#" class="fb"><i class="fa fa-facebook"></i></a>
                                </li>
                                <li>
                                    <a href="registration.html#" class="twit"><i class="fa fa-twitter"></i></a>
                                </li>
                                <li>
                                    <a href="registration.html#" class="linkedin"><i class="fa fa-linkedin"></i></a>
                                </li>
                                <li>
                                    <a href="registration.html#" class="google"><i class="fa fa-google-plus"></i></a>
                                </li>
                                <li>
                                   <a href="registration.html#" class="skype"><i class="fa fa-skype"></i></a>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="copyright">
                            <p class="desktop">
                                Copyright &copy; 2017 <a href="registration.html#">kick</a>
