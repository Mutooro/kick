        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-3 col-sm-6">
                    <a href="assets/img/player-gallery-5.jpg" class="gallery-lightbox">
                        <div class="project-img player-gallery-single">
                            <img src="assets/img/player-gallery-5.jpg" alt="single project" />
                        </div>
                    </a>
                </div>
                <div class="col-md-3 col-sm-6">
                    <a href="assets/img/player-gallery-4.jpg" class="gallery-lightbox">
                        <div class="project-img player-gallery-single">
                            <img src="assets/img/player-gallery-4.jpg" alt="single project" />
                        </div>
                    </a>
                </div>
                <div class="col-md-3 col-sm-6">
                    <a href="assets/img/player-gallery-6.jpg" class="gallery-lightbox">
                        <div class="project-img player-gallery-single">
                            <img src="assets/img/player-gallery-6.jpg" alt="single project" />
                        </div>
                    </a>
                </div>
                <div class="col-md-3 col-sm-6">
                    <a href="assets/img/player-gallery-3.jpg" class="gallery-lightbox">
                        <div class="project-img player-gallery-single">
                            <img src="assets/img/player-gallery-3.jpg" alt="single project" />
                        </div>
                    </a>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6">
                    <a href="assets/img/player-gallery-2.jpg" class="gallery-lightbox">
                        <div class="project-img player-gallery-single">
                            <img src="assets/img/player-gallery-2.jpg" alt="single project" />
                        </div>
                    </a>
                </div>
                <div class="col-md-3 col-sm-6">
                    <a href="https://themescare.com/demos/kick-view/assets/img/player-gallery-1.jpg" class="gallery-lightbox">
                        <div class="project-img player-gallery-single">
                            <img src="https://themescare.com/demos/kick-view/assets/img/player-gallery-1.jpg" alt="single project" />
                        </div>
                    </a>
                </div>
            </div>
