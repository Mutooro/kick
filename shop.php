...
<body>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="breadcromb-box">
                        <h2>shop</h2>
                        <ul>
                            <li><a href="shop.html#"><i class="fa fa-home"></i> home</a></li>
                            <li>/</li>
                            <li>shop</li>
                        </ul>
                    </div>
    ...
    <section class="kick-top-products-page-area section_100">
        <div class="container">
            <div class="row">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="pagination-box">
                        <ul class="pagination">
                            <li><a href="shop.html#"><i class="fa fa-angle-double-left"></i></a></li>
                            <li><a href="shop.html#">1</a></li>
                            <li><a href="shop.html#">2</a></li>
                            <li class="active"><a href="shop.html#">3</a></li>
                        ...
                        <div class="single-footer-widget">
                            ...
                            <ul class="single-footer-address">
                                ...
                                <li>
                                    ...
                                    <p><a href="shop.html#">info@companyname.co</a></p>
                                </li>
                                <li>
                                    <div class="add-icon">
                                        <i class="fa fa-phone"></i>
                                    </div>
                                    <p><a href="shop.html#">+123-456-78990</a></p>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="single-footer-widget">
                            ...
                            <ul class="single-footer-social">
                                <li>
                                    <a href="shop.html#" class="fb"><i class="fa fa-facebook"></i></a>
                                </li>
                                <li>
                                    <a href="shop.html#" class="twit"><i class="fa fa-twitter"></i></a>
                                </li>
                                <li>
                                    <a href="shop.html#" class="linkedin"><i class="fa fa-linkedin"></i></a>
                                </li>
                                <li>
                                    <a href="shop.html#" class="google"><i class="fa fa-google-plus"></i></a>
                                </li>
                                <li>
                                   <a href="shop.html#" class="skype"><i class="fa fa-skype"></i></a>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="copyright">
                            <p class="desktop">
                                Copyright &copy; 2017 <a href="shop.html#">kick</a>
